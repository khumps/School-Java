...
public class Box extends Shape {
	...
	/*
	 * Paints the box on the screen starting at the given x and y on the right
	 * screen
	 */
	...
	/*
	 * Paints the box on the screen starting at the given point on the given
	 * screen
	 */
