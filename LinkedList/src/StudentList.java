public class StudentList
	{
		...
		/**
		 * Puts str in between two lines so it can be seen easier
		 * 
		 * @param str
		 *            String for header
		 */
		...
		/**
		 * Inserts a Student by lastName
		 * 
		 * @param node
		 *            The StudentNode to be inserted
		 * @return the Student object inserted
		 */
		...
		/**
		 * Sorts the StudentList by student.lastName
		 */
		 ...
		 * 
		 * @param node
		 *            the StudentNode to begin sorting at
		 */
		...
		/**
		 * Inserts a Student by student.average
		 * 
		 * @param s
		 * @return the Student inserted
		 */
		...
		/**
		 * Sorts the StudentList by average
		 */
