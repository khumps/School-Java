...
public class Statistics {
	...
	/*
	 * Returns the Lower Quartile for the data
	 */
	...
	public static ArrayList<Double> mode(double[] data) {
		...
		if (noMode > values.size() / 2) 
			/*
			 * If more then half of the data values occurred
	...
	/*
	 * Returns an ArrayList<Double> of all outliers in the set of data
	 * If the data set has a length less then 6 then there is never an outlier
	 */
